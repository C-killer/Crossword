...
public class GrilleLoader {
    ...
    /**
     * Saves the specified Grille object to a file at the given path.
     *
     * @param g the Grille object to be saved
     * @param path the file path where the Grille object will be saved
     */
    public static void saveGrille(Grille g, String path) {
        try {
            PrintWriter pw = new PrintWriter(path);
            pw.print(serialize(g,true));    // 将网格内容转换为字符串并写入文件
            pw.close();
        } catch (IOException e) {
